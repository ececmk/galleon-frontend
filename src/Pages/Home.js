...
function Home(props) {
  return (
    <>
      <div className="flex flex-col bg-[#7F3DFF] items-center justify-between ">
        <div className="container px-4 mt-10 flex h-3/4  justify-between rounded-md pt-10 pb-20 flex-col lg:flex-row">
          <div className="pt-10 pl-5 w-3/4">
            ...
            <Link to="/signup">
            <button
              className="bg-white text-[#7F3DFF] font-[Poppins] text-xl font-semibold py-6 px-16 rounded md:ml-8 hover:bg-[#FCAC12]
    duration-500"
            >
              Let's get started!
              {props.children}
